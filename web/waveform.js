// Wrap in IIFE to avoid global name collisions
(function(){
  let canvas,ctx,state,audio,selIndex=-1;

  function initTimeline(_state,_audio){
  ...
  function getSelected(){return selIndex;}
  function setSelected(i){selIndex=i;}
  ...
  window.Waveform = { initTimeline, getSelected, setSelected };
})();
